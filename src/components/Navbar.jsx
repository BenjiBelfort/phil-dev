    ...
    <nav className="bg-black text-white px-6 h-20 fixed w-full top-0 z-50">
      <div className="container mx-auto flex justify-between items-center h-full">
        ...
        <ul className="hidden md:flex space-x-8 uppercase">
          <li><a href="#about" className="font-secondary hover:text-gray-400">Présentation</a></li>
          <li><a href="#gallery" className="font-secondary hover:text-gray-400">Galerie</a></li>
          <li><a href="#agenda" className="font-secondary hover:text-gray-400">Agenda</a></li>
          <li><a href="#contact" className="font-secondary hover:text-gray-400">Contact</a></li>
        </ul>
        ...
        <div className={`uppercase mobile-menu fixed top-0 right-0 h-full w-full bg-black shadow-lg transform transition-transform duration-300 md:hidden ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
            <ul className="flex flex-col justify-center space-y-4 w-full h-full text-center gap-4">
                <li><a href="#about" className={`font-secondary block text-lg hover:text-gray-400 transition-transform duration-300 ease-in ${isOpen ? "translate-x-0" : "translate-x-full"}`} onClick={() => setIsOpen(false)}>Présentation</a></li>
                <li><a href="#gallery" className={`font-secondary block text-lg hover:text-gray-400 transition-transform duration-400 ease-in ${isOpen ? "translate-x-0" : "translate-x-full"}`} onClick={() => setIsOpen(false)}>Galerie</a></li>
                <li><a href="#agenda" className={`font-secondary block text-lg hover:text-gray-400 transition-transform duration-500 ease-in ${isOpen ? "translate-x-0" : "translate-x-full"}`} onClick={() => setIsOpen(false)}>Agenda</a></li>
                <li><a href="#contact" className={`font-secondary block text-lg hover:text-gray-400 transition-transform duration-600 ease-in ${isOpen ? "translate-x-0" : "translate-x-full"}`} onClick={() => setIsOpen(false)}>Contact</a></li>
